...
class OffsetGaitGenerator(gait_generator.GaitGenerator):
    ...
    def reset(self, current_time):
        ...
        self.prev_frame_robot_time = current_time #self.robot.time_since_reset
        self.last_action_time = current_time #self.robot.time_since_reset
        self.swing_cutoff = 2 * np.pi * 0.5

    def update(self, current_time):
        # Calculate the amount of time passed
        current_robot_time = current_time #self.robot.time_since_reset
        #frame_duration = self.robot.time_since_reset - self.prev_frame_robot_time
        frame_duration = current_time - self.prev_frame_robot_time
    ...
    def leg_state(self):
        ...
        contact_state = self.robot.GetFootContacts() #self.robot.foot_contacts
